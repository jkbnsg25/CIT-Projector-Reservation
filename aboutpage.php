...
<head>
    ...
    <title>About Us - CIT ProJector Reservation</title>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        ...
                        <li class="nav-item px-2">
                            <a class="nav-link active" href="aboutpage.php">About Us</a>
                        </li>
                    </ul>
                    </div>
                </div>
    ...
    <section class="body">
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-12">
                    <img src="images/team-img.svg" alt="team image" class="mw-100" style="margin-top:60px;margin-bottom: 30px;">
                </div>
                <div class="col-12">
                    <p>The CIT Projector Reservation System is an online platform designed to simplify the booking process for projectors 
                    at the Office of the Dean, CIT-CBSUA. Created by Jake Bansig, Charline Suarilla, and Michelle Sayat, it aims to provide
                    a user-friendly experience with real-time availability updates. The system is accessible to all CIT students, and faculties 
                    ensuring everyone has the resources needed for successful presentations during class hours.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row team-pic">
                <div class="col-4 text-center">
                    <img src="images/jake.jpg" alt="Jake" class="mw-100" style="margin-top: 60px; margin-bottom: 30px;">
                    <h3 style="margin-top: 20px;">Jake Bansig</h3>
                </div>
                <div class="col-4 text-center">
                    <img src="images/cha.png" alt="Charline" class="mw-100" style="margin-top: 60px; margin-bottom: 30px;">
                    <h3 style="margin-top: 20px;">Charline Suarilla</h3>
                </div>
                <div class="col-4 text-center">
                    <img src="images/michelle.jpg" alt="Michelle" class="mw-100" style="margin-top: 60px; margin-bottom: 30px;">
                    <h3 style="margin-top: 20px;">Michelle Sayat</h3>
                </div>
            </div>
        </div>
    </section>
