            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="h1-text col-lg-12 text-center">
                        <h1 style="margin-top: -20px; margin-bottom: 20px; font-size: 40px;"><span style="color: #471847; font-weight: bolder;">MESSAGES</h1>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <table class="table">
                            ...
                            <?php
                                $sql = "SELECT u.name, u.username, c.message
                                FROM USER u
