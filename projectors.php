...
<header>
        <nav class="navbar navbar-expand-lg fixed-top">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <h1 class="mb-0" style="flex-grow: 1; text-align: center; font-size: 40px; padding-bottom: 10px;"><span style="color: white; font-weight: bolder;">CIT PRO</span><span style="color: #FECC6B; font-weight: bolder; font-size: 50px;">J</span><span style="color: white; font-weight: bolder;">ECTOR RESERVATION - ADMIN</span> </h1>
                    </div>
                </div>
                <div class="dropdown">
    ...
    <div class="main">
        ...
        <section class="body">
            <div class="container">
                    <a href="admin.php">
                            <i class="fa-solid fa-arrow-left" style="margin-top: 80px; font-size:30px; color:#471847"></i>
                    </a>
                <div class="row">
                    <div class="h1-text col-lg-12 text-center">
                        <h1 style="margin-top: -20px; margin-bottom: 20px; font-size: 40px;"><span style="color: #471847; font-weight: bolder;">PROJECTORS</h1>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <?php
                                    include 'connection.php';
                                    $sql = "SELECT proj_id, proj_name FROM PROJECTOR";
                                ...
                                ?>
                                <tr>
                                    <td colspan="10" class="text-center">No projectors found.</td>
                                </tr>
                                <?php endif; ?>
                            </table>
                        </div>
