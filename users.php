            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="h1-text col-lg-12 text-center">
                        <h1 style="margin-top: -20px; margin-bottom: 20px; font-size: 40px;"><span style="color: #471847; font-weight: bolder;">USERS</h1>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <?php
                                    include 'connection.php';
                                    $sql = "SELECT name, username, role FROM USER WHERE role != 'CIT-Admin'";
